...
# Transpose the matrix and join the characters to form the decoded string
decoded_string = ''.join([''.join([matrix[row][col] for row in range(n)]) for col in range(m)])

# Use a regular expression to replace sequences of non-alphanumeric characters between alphanumerics with a space
